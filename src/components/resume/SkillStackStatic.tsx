...
const SkillStacks: Array<{ icon: JSX.Element, title: string, content: JSX.Element | string }> = [
  {
    ...
    content: <>
      ...
      <div>Context와 Mobx를 통한 전역 상태관리 경험이 있습니다.</div>
  ...
  },
  {
    ...
    content: <>
      ...
      <div>사용하는 라이브러리와 프레임워크에 타입을 이해하고 알맞게 사용을 할 수 있습니다. 인터페이스를 설계 및 작성을하여 안전하고 실용적인 코드를 구현 할 수 있습니다.</div>
    </>,
  },
  {
    icon: <NodeJSIcon />,
  ...
  },
  {
    ...
    title: "Express.js",
    content: <>
      <div>미들웨어에 대한 기본적인 이해도가 있으며, Express.js를 사용한 REST API를 개발하여 실무에서 사용해본 경험이 있습니다.</div>
    </>,
  },
  {
    icon: <PHPIcon />,
  ...
  },
  {
    ...
    content: <>
      ...
      <div>Hasura를 통해 GraphQL을 사용하여 사이드 프로젝트 경험이 있습니다. </div>
    </>,
  },
  {
    icon: <MySQLIcon />,
